...
Verifica se o numero pertence ao intervalo aberto entre 20 e 55 */
void verificarIntervalo(int numero) {
    if (numero > 20 && numero < 55) {
        printf("\nO numero %d pertence ao intervalo aberto entre 20 e 55.\n", numero);
    } else {
        printf("\nO numero %d nao pertence ao intervalo aberto entre 20 e 55.\n", numero);
    }
}
...
int main(void) {
    ...
    verificarIntervalo(numero); // Verifica se o numero esta no intervalo
